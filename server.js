...
// afficher les elements a partir de fichier ejs

// app.get('/about', function(req, res){
//   res.render('about.ejs', {Salut: 'Bienvenu sur la page about.ejs'});
// })
//
...
//     let noms = [{id: 0, firstName: 'Michel'}, {id: 1, firstName: 'Osman'}, {id: 2, firstName: 'Tandi'}, {id: 3, firstName: 'Daniel'}, {id: 4, firstName: 'Faustino'}, {id: 5, firstName: 'Ijacques'}];
//     res.render('noms.ejs', {noms: noms});
//   });
...
// res.send('Le Nom de Utilistateur: ' + users[req.params.id].firstName);
//   res.send(`Le Nom de Utilistateur: ${users[req.params.id].firstName}`);
